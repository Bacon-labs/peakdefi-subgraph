...
export let KYBER_ADDR = Address.fromString("0x9AAb3f75489902f3a48495025729a0AF77d4b11e")
export let USDC_ADDR = Address.fromString("0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48")
